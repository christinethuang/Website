...
The second example is extracted from a homework I was assigned in class. 

The following presents with several real-world strings. The task is to use regular expressions in python to match (and return) the requested parts in each. Using re.findall(), match all numbers and pull them from the following string (string1).
