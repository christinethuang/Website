...
Although there are many more advantages and disadvantages between Python and R, listed below are the characteristics that I personally noticed.  

Python:
- has a more simplified syntax (ex. has less braces and parentheses)
- is more popularly used among people

R:
- is used more often and specifically in biostats and for biology majors
- offers more easily accessible packages 
